...
if (tete == '6285812373011') return m.reply(`napa ke owner gw banh?`)
let jumlah = q.split("|")[1]
...
case 'addprem':
if (!XeonTheCreator) return replygcxeon(mess.owner)
if (!args[0]) return replygcxeon(`Use ${prefix+command} number\nExample ${prefix+command} 6285812373011`)
...
let e = String(err)
XeonBotInc.sendMessage("6285812373011@s.whatsapp.net", { text: "Hello developer, there seems to be an error, please fix it " + util.format(e), 
contextInfo:{
forwardingScore: 9999999, 
isForwarded: true
}})
